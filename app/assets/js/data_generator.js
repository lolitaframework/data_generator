...
(function (LolitaFramework) {
    var DataGeneratorPost = (function () {
        function DataGeneratorPost() {
            ...
            jQuery(document).on('click', '#data_generator_post_generate', function (e) { return _this.generatePosts(e); });
            jQuery(document).on('click', '#data_generator_post_deleta_all', function (e) { return _this.deletePosts(e); });
        }
...
(function (LolitaFramework) {
    var DataGeneratorTerm = (function () {
        function DataGeneratorTerm() {
            ...
            this.api = null;
            this.api = window.wp.customize;
            jQuery(document).on('click', '#data_generator_term_generate', function (e) { return _this.generateTerms(e); });
            jQuery(document).on('click', '#data_generator_term_deleta_all', function (e) { return _this.deleteTerms(e); });
        }
